...
// Sets the Erasure coding parameters
func (n *ProtoNode) SetEC(or int, par int) {
	n.Ec = true
	n.Or = or
	n.Par = par
}
...
// Sets the Erasure coding parameters
func (n *ProtoNode) SetChunkSize(chunksize int) {
...
func (n *ProtoNode) Size() (uint64, error) {
	...
	en = time.Now()
	n.timetoincrease += en.Sub(st)
	fmt.Fprintf(os.Stdout, " Time Taken To protoo : %s \n", n.timetoproto.String())
	fmt.Fprintf(os.Stdout, " Time Taken To increase sizes : %s \n", n.timetoincrease.String())
	return s, nil
}
...
func (n *ProtoNode) Stat() (*format.NodeStat, error) {
	...
	return &format.NodeStat{
		...
		NumLinks:       n.Or,
		BlockSize:      n.Par,
		LinksSize:      n.chunksize, // includes framing.
		DataSize:       0,
		CumulativeSize: 0,
	}, nil
}
